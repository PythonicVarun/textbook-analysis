...
# Store all reports for export
all_reports = []


def generate_full_report_markdown(
    reports: list[dict], filename: str, model_name: str
) -> str:
    """Generate a complete markdown report from all page reports."""
...
"""
    ...
    for report in reports:
        md += f"- [Page {report['page_num']}](#page-{report['page_num']})\n"

    md += "\n---\n\n"

    # Add each page's report
    for report in reports:
        md += f"""
<a id="page-{report['page_num']}"></a>
...
*This report was automatically generated by the [Textbook Fact Checker tool](https://github.com/PythonicVarun/textbook-analysis).*
"""
    ...
    if not uploaded_file:
        ...
        try:
            ...
            if total_pages == 0:
                ...
                # Collect all reports for export
                collected_reports = []
                ...
                if collected_reports:
                    ...
                    full_report_md = generate_full_report_markdown(
                        collected_reports, uploaded_file.name, model_name
                    )

                    # Create filename for download
                    base_name = os.path.splitext(uploaded_file.name)[0]
                    timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
                    export_filename = f"{base_name}_fact_check_report_{timestamp}.md"
                    ...
                    with col2:
                        st.metric("Pages Analyzed", len(collected_reports))
